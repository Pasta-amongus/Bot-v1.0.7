...
with open('config.json') as f:
    try:
        ...
        print(Fore.RED + ' [ERROR] ' + Fore.RESET + "There was an error in one of the bot's files! (config.json). If you have problems trying to fix it, join the discord support server for help - https://discord.gg/wyTdJ85TbK")
...
with open('info.json') as f:
    try:
        ...
        print(Fore.RED + ' [ERROR] ' + Fore.RESET + "There was an error in one of the bot's files! (info.json) If you have problems trying to fix it, join the discord support server for help - https://discord.gg/wyTdJ85TbK")
        print(Fore.LIGHTRED_EX + f'\n {e}')
        exit(1)
